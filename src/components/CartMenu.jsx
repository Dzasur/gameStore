...
const CartMenu = ({ items, onClick }) => {
  return (
    <div className="cart-menu absolute top-9 right-0 rounded-2xl">
      <div className="py-2 text-base opacity-90 font-normal flex flex-col gap-3">
      ...
      {items.length > 0 ? (
        <div>
          ...
          <button
            className="btn-buy text-sm rounded-[15px] font-normal text-white border-none p-2 mb-3"
            onClick={onClick}
          >
            Оформить заказ
          </button>
